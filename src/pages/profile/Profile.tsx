...
const TIMEZONES_WITH_EMPTY = [{ value: '', label: 'Select Timezone' }, ...TIMEZONES]
...
function ProfileInfoSection({ user, avatarFile, onNameChange }: ProfileInfoProps) {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      // Backend returns only { success, message } — update auth store with form values we sent
      updateUser({

...
import {
  Plus, Pencil, Trash2, Radio, Save, X, ArrowLeft, Copy, Eye,
} from 'lucide-react'
    ...
    <>
      ...
      <div className="space-y-5">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="page-header">
              <div>
                <h1 className="page-title">SMS AI Campaigns</h1>
                <p className="page-subtitle">Manage AI-powered SMS campaigns</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <ServerDataTable<CampaignItem>
          ...
          headerActions={
            <button onClick={() => { setEditCampaign(null); setShowCreate(true) }} className="btn-primary">

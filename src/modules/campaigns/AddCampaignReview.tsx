...
import {
  ArrowLeft, CheckCircle2, Radio, Phone, Clock, Tag, Mail, Zap, List,
  Globe, Hash, Users, PartyPopper,
} from 'lucide-react'
    ...
    <div className="w-full animate-fadeIn space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900 leading-none">Review Campaign</h1>

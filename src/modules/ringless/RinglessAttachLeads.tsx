...
export function RinglessAttachLeads() {
  ...
  const assignMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      navigate(`/ringless/${campaignId}/add-review`)
    },
    onError: (err: unknown) => {
    ...
    return (
      <div className="w-full space-y-4 animate-fadeIn">
        ...
        <ServerDataTable<ListRow>
          queryKey={['lists-attach-ringless']}
    ...
    <div className="w-full space-y-4 animate-fadeIn">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Ringless Campaign #{campaignId} — add a lead list</p>
          </div>
        </div>
        <button type="button" onClick={() => navigate(`/ringless/${campaignId}/add-review`)}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button
          ...
          className="group bg-white rounded-2xl border border-slate-200 p-6 text-left hover:border-blue-300 hover:shadow-md transition-all"
      ...
      <div className="text-center pt-2">
        <button
          type="button"
          onClick={() => navigate(`/ringless/${campaignId}/add-review`)}
